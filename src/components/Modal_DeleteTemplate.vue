<template>
    <div class="deletemodal-overlay">
      <div class="deletemodal">
        ...
        <h1 class="modal-title">Are you sure you want to delete this template?</h1>
        
        <div class="deletemodal-action">
          <button @click="$emit('close')" class="deletecancel-button">
            <i class="fas fa-times modal-icon"></i> No, cancel
          </button>
          <button @click="deleteTemplate" class="deleteconfirm-button">
  ...
  const deleteTemplate = () => {
    // det der gør, som man kan slette templatet - kan være api her? 
